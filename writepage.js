      ...
      <section style={{ backgroundColor: '#0A2342' }}>
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/jobs" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-medium text-sm" style={{ backgroundColor: '#FAF7F2', color: '#0A2342' }}>
