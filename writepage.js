...
const SECTOR_ACCENT: Record<string, string> = {
  law_firm: '#8B3A3A', banking: '#0A4A8C', energy: '#7A3B00', fintech: '#0E5C3A', other: '#3B3B3B'
}
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-cream font-sans" style={{ paddingTop: '64px' }}>
      ...
      <section style={{ backgroundColor: '#8B3A3A' }}>
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/jobs" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-medium text-sm" style={{ backgroundColor: '#FAF7F2', color: '#8B3A3A' }}>
              Create Job Alert <ArrowRight size={16} />
            </Link>
            <Link href="/jobs" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg font-medium text-sm" style={{ border: '1px solid rgba(250,247,242,0.2)', color: '#FAF7F2' }}>
...
export default function HomeIcons({ type }: { type: string }) {
  if (type === 'hero') return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" className="w-full max-w-md" aria-hidden="true">
      <g><path d="M415.34,324.94s37.13-44.87,27.13-123S381.07,101.26,348.23,101,284,136.83,239.7,144.11,134,130.72,84.06,148.2,29.8,270.79,70.5,312.18,197.58,351.94,249,341.55,377.5,372.69,415.34,324.94Z" fill="#8B3A3A" opacity="0.05"/></g>
      <g>
        <polygon points="253,306 251,139 284,139 283,311" fill="#FAF7F2" stroke="#8B3A3A" strokeWidth="1"/>
        <polygon points="284,139 310,139 308,294 283,311" fill="#1A1A1A" opacity="0.75"/>
        <rect x="280" y="84" width="2" height="35" fill="#8B3A3A" opacity="0.5"/>
        <polygon points="267,125 267,117 295,117 295,126" fill="#FAF7F2" stroke="#8B3A3A" strokeWidth="1"/>
        <polygon points="282,125 282,117 295,117 295,126" fill="#1A1A1A" opacity="0.7"/>
        <polygon points="251,139 258,131 284,131 284,139" fill="#FAF7F2" stroke="#8B3A3A" strokeWidth="1"/>
        <polygon points="284,131 304,132 310,139 284,139" fill="#1A1A1A" opacity="0.7"/>
      </g>
      <g>
        <polygon points="306,197 362,201 381,196 324,192" fill="#FAF7F2" stroke="#8B3A3A" strokeWidth="1"/>
        <polygon points="362,201 361,295 379,287 381,196" fill="#1A1A1A" opacity="0.65"/>
        <polygon points="306,197 306,284 361,295 362,201" fill="#FAF7F2" stroke="#8B3A3A" strokeWidth="1"/>
        <rect x="311" y="202" width="42" height="21" fill="#8B3A3A" opacity="0.75"/>
