            ...
            <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 2rem 6rem' }}>
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                <input
                  ...
                  style={{
                    width: '100%', padding: '0.85rem 0', fontFamily: 'Playfair Display, Georgia, serif',
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2.5rem' }}>
                <div>
                  ...
                  <input
                    ...
                    style={{
                      width: '100%', padding: '0.6rem 0', fontFamily: 'DM Sans, sans-serif',
                      fontSize: '0.92rem', color: ink, backgroundColor: 'transparent',
                      border: 'none', borderBottom: '1px solid ' + rule, outline: 'none', boxSizing: 'border-box' as const,
                    }}
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    style={{
                      width: '100%', padding: '0.6rem 0', fontFamily: 'DM Sans, sans-serif',
                      fontSize: '0.92rem', color: ink, backgroundColor: 'transparent',
                      border: 'none', borderBottom: '1px solid ' + rule, cursor: 'pointer', boxSizing: 'border-box' as const,
                    }}
                  >
              ...
              <div
                ...
                style={{
                  border: dragOver ? '1px dashed ' + accent : '1px dashed #D5C9BC',
                  padding: '3rem 1.5rem',
                  textAlign: 'center' as const,
                  backgroundColor: dragOver ? 'rgba(139,58,58,0.04)' : 'transparent',
                  marginBottom: '2rem',
              ...
              >
                ...
                {file ? (
                  <div>
                    ...
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.88rem', color: ink, fontWeight: 600, marginBottom: '0.25rem' }}>{file.name}</p>
                    <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '0.76rem', color: muted, marginBottom: '0.75rem' }}>{(file.size / 1024).toFixed(0)} KB</p>
                    <button
