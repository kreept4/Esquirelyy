...
// Create directories
fs.mkdirSync('src/app/api/cover-letter', { recursive: true });
fs.mkdirSync('src/app/tools/cover-letter', { recursive: true });

// ─── API ROUTE ────────────────────────────────────────────────
fs.writeFileSync('src/app/api/cover-letter/route.ts', `import { NextRequest, NextResponse } from 'next/server'
