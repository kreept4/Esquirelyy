...
fs.writeFileSync('src/middleware.ts', `import { NextResponse, type NextRequest } from 'next/server'
...
const WELCOME_COPY = {
  student: {
    ...
    body: [
      ...
      "Glad to have you. Let's get started."
    ]
  },
  graduate: {
    headline: 'You belong in this room.',
    body: [
      "Whether you are navigating call to bar, figuring out NYSC placement, hunting for your first associate position, or looking for your next move at a larger firm or in-house team, you are in the right place.",
