...
const iconStyle = { color: '#0A2342' }

const SmartJobBoardIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0A2342" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" style={iconStyle}>
...
const ApplicationTrackerIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0A2342" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
