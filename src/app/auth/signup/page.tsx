    ...
    <div className="auth-page">
      <div className="auth-form-col">
        <div className="auth-form-wrap" style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Space Mono, monospace', fontSize: '1.5rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '0.75rem' }}>Check your email.</h2>
          <p style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.88rem', color: '#4A4A4A', lineHeight: 1.7, marginBottom: '2rem' }}>
            We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.
          </p>
          <Link href="/auth/login" style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.78rem', fontWeight: 600, color: '#1A1A1A', textDecoration: 'none' }}>Back to sign in</Link>
        </div>
      </div>
      <AuthStyles />
    </div>
      ...
      <div className="auth-form-col">
        <div className="auth-form-wrap">
          ...
          <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              <label style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.7rem', fontWeight: 600, color: '#1A1A1A', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>Full name</label>
            ...
            <div>
              <label style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.7rem', fontWeight: 600, color: '#1A1A1A', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>Password</label>
